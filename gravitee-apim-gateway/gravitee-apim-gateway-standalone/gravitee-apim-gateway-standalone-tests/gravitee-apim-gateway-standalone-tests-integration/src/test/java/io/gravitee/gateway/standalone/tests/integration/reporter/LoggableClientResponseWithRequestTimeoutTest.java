 ...
 */
package io.gravitee.gateway.standalone.tests.integration.reporter;
 ...
 */
@ApiDescriptor(value = "/io/gravitee/gateway/standalone/tests/integration/http/teams.json", configFolder = "/gravitee-requestTimeout")
