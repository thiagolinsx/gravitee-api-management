...
public class QueryParametersTest extends AbstractWiremockGatewayTest {
    ...
    public void call_get_query_params() throws Exception {
        wireMockRule.stubFor(
            WireMock
                ...
                .willReturn(WireMock.ok().withBody("{{request.query.q}}").withTransformers("response-template"))
        );
    ...
    public void call_get_query_with_json_content() throws Exception {
        wireMockRule.stubFor(WireMock.get(WireMock.urlPathEqualTo("/team/my_team")).willReturn(WireMock.ok()));
        ...
        wireMockRule.verify(WireMock.getRequestedFor(WireMock.urlEqualTo("/team/my_team?" + target.getRawQuery())));
    }
    ...
    public void call_get_query_with_multiple_parameter_values() throws Exception {
        ...
        wireMockRule.verify(WireMock.getRequestedFor(WireMock.urlEqualTo(encoder.toString())));
    }
    ...
    public void call_get_query_with_multiple_parameter_values_ordered() throws Exception {
        ...
        wireMockRule.verify(WireMock.getRequestedFor(WireMock.urlEqualTo("/team/my_team?" + query)));
    }
