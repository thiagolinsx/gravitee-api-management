 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/http/special-character-endpoint.json")
public class SpecialCharacterEndpointGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void call_get_started_api_noBody() throws Exception {
        wireMockRule.stubFor(WireMock.get("/team/%7Btest%7Cpipe%7D/%5Btest%5D/my_team").willReturn(WireMock.ok()));
        ...
        wireMockRule.verify(WireMock.getRequestedFor(WireMock.urlPathEqualTo("/team/%7Btest%7Cpipe%7D/%5Btest%5D/my_team")));
    }
}
