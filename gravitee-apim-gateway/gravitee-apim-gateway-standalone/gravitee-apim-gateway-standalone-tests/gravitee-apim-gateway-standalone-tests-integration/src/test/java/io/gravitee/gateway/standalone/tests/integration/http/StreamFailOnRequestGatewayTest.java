...
import io.gravitee.gateway.standalone.tests.integration.policy.TransformRequestStreamFailPolicy;
 ...
 */
@ApiDescriptor(value = "/io/gravitee/gateway/standalone/tests/integration/http/transform-request-content-fail.json")
public class StreamFailOnRequestGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldStreamFailOnRequest() throws Exception {
        ...
        wireMockRule.verify(0, WireMock.postRequestedFor(WireMock.urlPathEqualTo("/api")));
    }
