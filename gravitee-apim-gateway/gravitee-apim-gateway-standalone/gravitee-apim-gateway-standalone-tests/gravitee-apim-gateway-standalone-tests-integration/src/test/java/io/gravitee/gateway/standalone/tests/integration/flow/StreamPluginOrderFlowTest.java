 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/simple-request-stream-flow.json")
public class StreamPluginOrderFlowTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldRunFlows() throws Exception {
        ...
        wireMockRule.verify(
            WireMock.getRequestedFor(WireMock.urlPathEqualTo("/team/my_team")).withRequestBody(WireMock.equalTo("OnRequestContent2Policy"))
        );
