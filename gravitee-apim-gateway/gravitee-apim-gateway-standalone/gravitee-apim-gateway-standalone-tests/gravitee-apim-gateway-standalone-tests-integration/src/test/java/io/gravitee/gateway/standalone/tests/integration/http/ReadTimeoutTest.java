 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/http/read-timeout.json")
public class ReadTimeoutTest extends AbstractWiremockGatewayTest {

    @Test
    public void call_read_timeout_api() throws Exception {
        wireMockRule.stubFor(WireMock.get("/").willReturn(WireMock.serviceUnavailable().withFixedDelay(2000)));
        ...
        wireMockRule.verify(WireMock.getRequestedFor(WireMock.urlPathEqualTo("/")));
    }
}
