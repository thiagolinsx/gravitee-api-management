...
import io.gravitee.gateway.standalone.tests.sdk.flow.policy.Header1Policy;
import io.gravitee.gateway.standalone.tests.sdk.flow.policy.OnRequestPolicy;
import io.gravitee.gateway.standalone.tests.sdk.flow.policy.Stream1Policy;
import io.gravitee.gateway.standalone.tests.sdk.flow.policy.Stream2Policy;
 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/conditional-policy-flow.json")
public class ConditionalPolicyTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldRunPoliciesWithPassingCondition() throws Exception {
        ...
        wireMockRule.verify(
            WireMock
                .getRequestedFor(WireMock.urlPathEqualTo("/team/my_team"))
                .withHeader("X-Gravitee-Policy", WireMock.equalTo("request-header1"))
                .withHeader("on-request-policy", WireMock.equalTo("invoked"))
        );
    }
