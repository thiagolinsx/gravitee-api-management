 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/invalid-conditional-stream-policy-flow.json")
public class InvalidConditionalStreamPolicyTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldNotRunPoliciesIfConditionIsInvalid() throws Exception {
        ...
        wireMockRule.verify(1, WireMock.anyRequestedFor(WireMock.anyUrl()));
    }
