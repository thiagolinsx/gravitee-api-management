 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/http/cors_wildcard_origin.json")
public class CorsWildcardTest extends AbstractWiremockGatewayTest {
    ...
    public void preflight_request() throws Exception {
        ...
        wireMockRule.verify(0, WireMock.optionsRequestedFor(WireMock.urlEqualTo("/team/my_team")));
    }
    ...
    public void simple_request_with_origin() throws Exception {
        ...
        Assert.assertEquals("x-forwarded-host", response.getFirstHeader(HttpHeaders.ACCESS_CONTROL_EXPOSE_HEADERS).getValue());
