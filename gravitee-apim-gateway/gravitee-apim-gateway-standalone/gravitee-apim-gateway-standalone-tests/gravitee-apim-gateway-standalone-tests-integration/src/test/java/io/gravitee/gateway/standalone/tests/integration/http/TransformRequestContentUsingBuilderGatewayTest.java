...
import io.gravitee.gateway.standalone.tests.integration.policy.TransformRequestContentUsingBuilderPolicy;
 ...
 */
@ApiDescriptor(value = "/io/gravitee/gateway/standalone/tests/integration/http/transform-request-content.json")
