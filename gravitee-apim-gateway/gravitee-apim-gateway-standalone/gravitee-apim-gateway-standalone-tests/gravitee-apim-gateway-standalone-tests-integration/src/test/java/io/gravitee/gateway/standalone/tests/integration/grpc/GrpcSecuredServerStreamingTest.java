 ...
 */
package io.gravitee.gateway.standalone.tests.integration.grpc;
...
import io.gravitee.gateway.standalone.tests.sdk.AbstractSecuredGatewayTest;
...
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/grpc/streaming-greeter.json")
