 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/cors-with-policies-flow.json")
public class CorsWithPoliciesFlowTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldRunFlows_preflightWithPolicies() throws Exception {
        ...
        wireMockRule.verify(
            0,
            WireMock.optionsRequestedFor(WireMock.urlEqualTo("/team/my_team")).withHeader("my-counter", WireMock.equalTo("1"))
        );
    }
