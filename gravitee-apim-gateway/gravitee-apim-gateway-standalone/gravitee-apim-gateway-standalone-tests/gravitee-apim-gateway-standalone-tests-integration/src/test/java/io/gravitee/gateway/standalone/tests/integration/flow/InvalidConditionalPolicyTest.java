 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/invalid-conditional-policy-flow.json")
public class InvalidConditionalPolicyTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldNotRunPoliciesIfConditionIsInvalid() throws Exception {
        ...
        wireMockRule.verify(0, WireMock.anyRequestedFor(WireMock.anyUrl()));
    }
