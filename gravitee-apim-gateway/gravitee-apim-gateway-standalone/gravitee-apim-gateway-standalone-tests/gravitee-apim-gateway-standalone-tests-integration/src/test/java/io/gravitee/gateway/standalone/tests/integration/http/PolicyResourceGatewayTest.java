...
import io.gravitee.gateway.standalone.tests.integration.policy.ResourcePolicy;
...
import io.gravitee.gateway.standalone.tests.sdk.policy.PolicyBuilder;
import io.gravitee.gateway.standalone.tests.sdk.resource.DummyResource;
import io.gravitee.gateway.standalone.tests.sdk.resource.ResourceBuilder;
 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/http/policy-resource.json")
public class PolicyResourceGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldReturnNotFound_unknownPolicy() throws Exception {
        ...
        Assert.assertEquals("Dummy Resource", response.getFirstHeader("X-Resource").getValue());
