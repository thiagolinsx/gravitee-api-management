...
import io.gravitee.gateway.standalone.tests.integration.policy.TransformResponseContentUsingBuilderPolicy;
 ...
 */
@ApiDescriptor(value = "/io/gravitee/gateway/standalone/tests/integration/http/transform-response-content.json")
