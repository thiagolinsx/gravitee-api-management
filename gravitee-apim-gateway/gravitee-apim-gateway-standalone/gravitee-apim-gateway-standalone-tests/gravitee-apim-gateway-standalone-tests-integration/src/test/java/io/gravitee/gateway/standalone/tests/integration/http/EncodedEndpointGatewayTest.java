 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/http/encoded-endpoint.json")
public class EncodedEndpointGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void call_get_started_api_noBody() throws Exception {
        wireMockRule.stubFor(WireMock.get("/team/test%257Cpipe/my_team").willReturn(WireMock.ok()));
        ...
        wireMockRule.verify(WireMock.getRequestedFor(WireMock.urlPathEqualTo("/team/test%257Cpipe/my_team")));
    }
}
