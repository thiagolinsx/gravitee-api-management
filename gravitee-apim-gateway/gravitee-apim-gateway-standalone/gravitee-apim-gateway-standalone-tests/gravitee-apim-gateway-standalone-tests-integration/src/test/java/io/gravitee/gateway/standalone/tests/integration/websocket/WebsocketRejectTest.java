 ...
 */
package io.gravitee.gateway.standalone.tests.integration.websocket;

import io.gravitee.common.http.HttpStatusCode;
import io.gravitee.gateway.standalone.tests.sdk.AbstractWebSocketGatewayTest;
import io.gravitee.gateway.standalone.tests.sdk.junit.annotation.ApiDescriptor;
import io.gravitee.gateway.standalone.tests.sdk.junit.rules.ApiDeployer;
...
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/websocket/teams.json")
