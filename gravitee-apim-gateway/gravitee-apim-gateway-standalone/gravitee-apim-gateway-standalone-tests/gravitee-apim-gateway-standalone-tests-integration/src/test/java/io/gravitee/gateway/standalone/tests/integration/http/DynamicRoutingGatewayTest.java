...
import io.gravitee.gateway.standalone.tests.integration.policy.DynamicRoutingPolicy;
 ...
 */
@ApiDescriptor(value = "/io/gravitee/gateway/standalone/tests/integration/http/dynamic-routing.json")
public class DynamicRoutingGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void call_dynamic_api() throws Exception {
        ...
        wireMockRule.verify(WireMock.getRequestedFor(WireMock.urlPathEqualTo("/team")));
    }
    ...
    public void call_dynamic_api_unavailable() throws Exception {
        ...
        wireMockRule.verify(0, WireMock.getRequestedFor(WireMock.urlPathEqualTo("/team")));
    }
