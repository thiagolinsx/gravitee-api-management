...
import io.gravitee.gateway.standalone.tests.integration.policy.ValidateResponsePolicy;
 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/http/handle-stream-content-error.json")
