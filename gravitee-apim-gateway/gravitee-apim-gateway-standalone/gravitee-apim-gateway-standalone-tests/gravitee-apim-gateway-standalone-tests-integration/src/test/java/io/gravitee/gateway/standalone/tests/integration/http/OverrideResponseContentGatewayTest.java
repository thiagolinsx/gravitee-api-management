...
import io.gravitee.gateway.standalone.tests.integration.policy.OverrideResponseContentPolicy;
 ...
 */
@ApiDescriptor(value = "/io/gravitee/gateway/standalone/tests/integration/http/override-response-content.json")
public class OverrideResponseContentGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldOverrideResponseContent() throws Exception {
        ...
        wireMockRule.stubFor(WireMock.post("/api").willReturn(WireMock.ok(requestBody)));
        ...
        wireMockRule.verify(1, WireMock.postRequestedFor(WireMock.urlPathEqualTo("/api")).withRequestBody(WireMock.equalTo(requestBody)));
    }
