 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/path-parameter-flow.json")
public class PathParameterFlowTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldRunFlows_withPathParameters() throws Exception {
        wireMockRule.stubFor(WireMock.get("/team/team/12345").willReturn(WireMock.ok()));
        ...
        wireMockRule.verify(
            WireMock.getRequestedFor(WireMock.urlPathEqualTo("/team/team/12345")).withHeader("my-counter", WireMock.equalTo("1"))
        );
    }
