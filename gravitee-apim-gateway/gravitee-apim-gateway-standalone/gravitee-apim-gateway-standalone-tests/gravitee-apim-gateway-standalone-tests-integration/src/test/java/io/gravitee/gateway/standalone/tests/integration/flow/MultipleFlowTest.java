 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/multiple-flow.json")
public class MultipleFlowTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldRunMultipleFlows() throws Exception {
        ...
        wireMockRule.verify(
            WireMock.getRequestedFor(WireMock.urlPathEqualTo("/team/my_team")).withHeader("my-counter", WireMock.equalTo("2"))
        );
    }
