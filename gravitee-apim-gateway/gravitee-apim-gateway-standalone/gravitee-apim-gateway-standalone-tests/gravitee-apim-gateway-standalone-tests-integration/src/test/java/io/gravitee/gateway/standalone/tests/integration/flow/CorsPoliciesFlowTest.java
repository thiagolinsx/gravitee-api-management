 ...
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/flow/cors-flow.json")
public class CorsPoliciesFlowTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldRunFlows_preflightRequest() throws Exception {
        ...
        wireMockRule.verify(0, WireMock.optionsRequestedFor(WireMock.urlEqualTo("/team/my_team")).withoutHeader("my-counter"));
    }
