...
import io.gravitee.gateway.standalone.tests.integration.http.SSLPKCS12TrustStoreTest;
...
/**
 * Based on keystore from {@link SSLPKCS12TrustStoreTest}
 *
 * @author David BRASSELY (david.brassely at graviteesource.com)
 * @author GraviteeSource Team
 */
@ApiDescriptor("/io/gravitee/gateway/standalone/tests/integration/http2/ssl-pkcs12-support.json")
public class Http2SSLPKCS12TrustStoreTest extends AbstractWiremockGatewayTest {
    ...
    public void http2_request_ssl_trustAll() throws Exception {
        ...
        response = execute(Request.Get("http://localhost:8082/test/my_team")).returnResponse();
        Assert.assertEquals(
            "trustAll is defined to false, with truststore => 200",
            HttpStatus.SC_OK,
            response.getStatusLine().getStatusCode()
        );
