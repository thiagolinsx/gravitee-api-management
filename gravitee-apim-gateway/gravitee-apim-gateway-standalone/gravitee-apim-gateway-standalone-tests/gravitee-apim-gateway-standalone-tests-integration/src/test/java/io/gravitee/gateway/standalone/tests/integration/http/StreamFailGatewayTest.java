...
import io.gravitee.gateway.standalone.tests.integration.policy.StreamFailer2Policy;
import io.gravitee.gateway.standalone.tests.integration.policy.StreamFailerPolicy;
 ...
 */
@ApiDescriptor(value = "/io/gravitee/gateway/standalone/tests/integration/http/stream-fail.json")
public class StreamFailGatewayTest extends AbstractWiremockGatewayTest {
    ...
    public void shouldNotProcessPolicyAfterStreamFail() throws Exception {
        wireMockRule.stubFor(WireMock.post("/api").willReturn(WireMock.serverError()));
