...
class PathMappingProcessorTest extends AbstractProcessorTest {
    ...
    public void beforeEach() {
        when(mockRequest.pathInfo()).thenReturn(PATH_INFO);
    }

    @Test
    public void shouldNotAddMappedPathWithEmptyMapping() {
        pathMappingProcessor = new PathMappingProcessor(Map.of());
    ...
    public void shouldAddMappedPathWithMapping() {
        pathMappingProcessor = new PathMappingProcessor(Map.of(PATH_INFO, Pattern.compile("/path/.*/info/")));
        pathMappingProcessor.execute(ctx).test().assertResult();
    ...
    public void shouldAddShortestMappedPathWithTwoMapping() {
        ...
        pathMappingProcessor =
            new PathMappingProcessor(Map.of(PATH_INFO, Pattern.compile("/path/.*/info/"), shorterPath, Pattern.compile("/path.*")));
        pathMappingProcessor.execute(ctx).test().assertResult();
